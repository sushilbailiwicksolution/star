                ...
                <div className="row">
                    ...
                    <div className="col-md-5 d-flex justify-content-between flex-column">
                        <div className="login-container">
                            ...
                            <p className="mt-3 mb-5 grey-text">Welcome back! Please login to your account.</p>
                            ...
                            <div className="d-flex justify-content-between mt-5">
                                <div className="form-group m-0 d-flex align-items-center">
                                    <div className="form-check d-flex align-items-center">
                                        ...
                                        <label className="form-check-label ml-4" htmlFor="gridCheck">
                                            Remember me
                                        </label>
                                    </div>
                                </div>
                                <button className="cl-btn cl-btn-primary btn-anchor"  onClick={(e) => { e.preventDefault(); props.history.push('/forgot-password') }}>Forgot password</button>
                            </div>
                            <div className="d-flex justify-content-between button-container">
                                <button className="cl-btn cl-btn-primary mr-5" onClick={userLogin}>Login</button>
