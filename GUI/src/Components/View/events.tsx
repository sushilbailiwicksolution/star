                  ...
                  <div className="light-card-bg p-4">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="row mb-2">
                          <div className="col-md-4 d-flex justify-content-between">
                            <p className="m-0 cl-white text-left">Severity :</p>
                            <span className="cl-white"></span>
                          </div>
                          <div className="col-md-8">
                            <p className="m-0 cl-white text-left event-style">
                            ...
                            <div className="col-md-8">
                              <p className="m-0 cl-white text-left event-style">
                                <div className="mutilselect-items">
                                  <div>
                                    <ul>
                                      {sevrityData.length > 0 ? (
                                        sevrityData.map((item: any) => {
                                          return (
                                            <li key={`severity${item.id}`}>
                                              <div className="checkbox-item">
                                                <input
                                                  type="checkbox"
