...
/**
 * This component is handling  dialog modal.
 * @component
 */
              ...
              <ul className="nav">
                <li className="nav-item">
                  <a href="#" className="nav-link text-white">
                    <i className="fas la-search-plus"></i>
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#" className="nav-link text-white">
                    <i className="fas la-search-minus"></i>
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#" className="nav-link text-white">
                    <i className="fas la-book-open"></i>
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#" className="nav-link text-white">
                    <i className="fas la-times"></i>
                  </a>
                </li>
              </ul>
            </div>
  ...
  return (
    <div className={togglebtn2 ? "modal-right show-modal" : "modal-right"}>
      <button
        className="btn btn-primary modal-btn"
        style={{ top: "250px" }}
        onClick={() => settogglebtn(!togglebtn2)}
      >
        {togglebtn2 ? (
          <ArrowForwardIosOutlinedIcon />
        ) : (
            ...
            <form action="">
              ...
              <div className="form-group form-check">
                <label className="form-check-label d-inline-flex align-items-center">
                  ...
                  <span className="pl-2">Internal Only</span>
                </label>
              </div>
