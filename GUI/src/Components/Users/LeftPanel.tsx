                    ...
                    <div className="list-wrapper user-list mt-4">
                        <ul>
                            <li className="px-3 active">
                                <div className="ml-2">
                                    <label className="m-0" onClick={() => {props.props.history.push('/users')}}>Users</label>
                                </div>
                            </li>
                            <li className="px-3">
                                <div className="ml-2">
                                    <label className="m-0" onClick={() => {props.props.history.push('/create-user')}}>Create Users</label>
                                </div>
                            </li>
                        </ul>
                    </div>
