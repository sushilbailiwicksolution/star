...
/**
 * This component is handling report page Engineering And Maintainance.
 * @component
 */
const EngineeringAndMaintainance = (props: any) => {
  ...
  const downloadExcel = () => {
    const fileName = "EngineeringAndMaintainance";
    const fileName_2 = "EngineeringAndMaintainance_Engines";
    const exportType = "xls";
    exportFromJSON({
      data: reportResponse.engineeringAndMaintainanceData.report_data_s2,
      fileName,
      exportType,
    });
    exportFromJSON({
      data: reportResponse.engineeringAndMaintainanceData.report_data_s3,
      fileName: fileName_2,
      exportType,
    });
  };
  ...
  const downloadPdf = () => {
    const reportName = "Engineering & Maintainance";
    const url = `${process.env.REACT_APP_URL}${process.env.REACT_APP_URL_OTHER_PORT_REPORT}${GET_REPORT}${GET_REPORT_ENG_MAINTAINANCE}/${reportResponse.selectedFlight}/${reportName}/pdf`;
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="row mb-2">
                            ...
                            <div className="col-md-8">
                              <p className="m-0 cl-white text-left">
                                {reportListData.report_data_s1.flightId?reportListData.report_data_s1.flightId:'NA'}
                              </p>
                            </div>
                          </div>
                          <div className="row mb-2">
                          ...
                          (reports: any, index: any) => {
                            return (
                              <tr key={index}>
                                ...
                                <td>{upToTwoDecimal(reports.param_value)==='0'?'NA':upToTwoDecimal(reports.param_value)}</td>
                                <td>{reports.unit}</td>
                              </tr>
                            );
                          }
