...
const EngineeringAndMaintainance = (props: any) => {
  ...
  const downloadExcel = () => {
    ...
    exportFromJSON({data:reportResponse.engineeringAndMaintainanceData.report_data_s2,fileName,exportType});
    exportFromJSON({data:reportResponse.engineeringAndMaintainanceData.report_data_s3,fileName:fileName_2,exportType});
