...
import { GET_REPORT, GET_REPORT_FLIGHT_SAFETY } from "../../Config/siteConfig";
...
const FlightSafety = (props: any) => {
  ...
  const downloadExcel = () => {
    ...
    exportFromJSON({
      data: reportResponse.flightSafetyData.report_data_s2,
      fileName,
      exportType,
    });
  };
  ...
  const downloadPdf = () => {
    const reportName = "Flight Safety";
    const url = `${process.env.REACT_APP_URL}${process.env.REACT_APP_URL_OTHER_PORT_REPORT}${GET_REPORT}${GET_REPORT_FLIGHT_SAFETY}/${reportResponse.selectedFlight}/${reportName}/pdf`;
...
<div className="dropdown custom-d-dropdown">
  ...
  <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <button className="dropdown-item" onClick={downloadPdf}>Download Pdf</button>
  </div>
  <button className="btn btn-outline-secondary ml-2" onClick={downloadExcel}>Download Excel</button>
  <button className="btn btn-outline-secondary ml-2" onClick={downloadPdf}>Download Pdf</button>
</div>
                          ...
                          (reports: any, index: any) => {
                            return (
                              <tr key={index}>
                                ...
                                <td></td>
                                <td>{upToTwoDecimal(reports.engine1_apuUsageGndAir)}</td>
                                <td>{upToTwoDecimal(reports.engine1_N1)}</td>
                                <td>{upToTwoDecimal(reports.engine1_N2)}</td>
                                <td>{upToTwoDecimal(reports.engine1_egtItt)}</td>
                                <td>{upToTwoDecimal(reports.engine1_Oil_Press)}</td>
                                <td>{upToTwoDecimal(reports.engine1_Oil_Temp)}</td>
                                <td>{upToTwoDecimal(reports.engine1_NAC_Temp)}</td>
                                <td>{upToTwoDecimal(reports.engine1_Vib_N1)}</td>
                                <td>{upToTwoDecimal(reports.engine1_Vib_N2)}</td>
                                <td>{upToTwoDecimal(reports.engine1_Fuel_Flow)}</td>
                                <td>{upToTwoDecimal(reports.engine2_N1)}</td>
                                <td>{upToTwoDecimal(reports.engine2_N2)}</td>
                                <td>{upToTwoDecimal(reports.engine2_egtItt)}</td>
                                <td>{upToTwoDecimal(reports.engine2_Oil_Press)}</td>
                                <td>{upToTwoDecimal(reports.engine2_Oil_Temp)}</td>
                                <td>{upToTwoDecimal(reports.engine2_NAC_Temp)}</td>
                                <td>{upToTwoDecimal(reports.engine2_Vib_N1)}</td>
                                <td>{upToTwoDecimal(reports.engine2_Vib_N2)}</td>
                                <td>{upToTwoDecimal(reports.engine2_Fuel_Flow)}</td>
                              </tr>
                            );
                          }
                        )}
