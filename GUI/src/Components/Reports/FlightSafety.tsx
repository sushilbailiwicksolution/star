...
/**
 * This component is handling report page Flight Safety.
 * @component
 */
                          ...
                          (reports: any, index: any) => {
                            return (
                              <tr key={index}>
                                ...
                                <td>
                                  {upToTwoDecimal(
                                    reports.engine1_apuUsageGndAir
                                  )}
                                </td>
                                <td>{upToTwoDecimal(reports.engine1_N1)}</td>
                                <td>{upToTwoDecimal(reports.engine1_N2)}</td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_egtItt)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_Oil_Press)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_Oil_Temp)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_NAC_Temp)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_Vib_N1)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_Vib_N2)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine1_Fuel_Flow)}
                                </td>
                                <td>{upToTwoDecimal(reports.engine2_N1)}</td>
                                <td>{upToTwoDecimal(reports.engine2_N2)}</td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_egtItt)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_Oil_Press)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_Oil_Temp)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_NAC_Temp)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_Vib_N1)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_Vib_N2)}
                                </td>
                                <td>
                                  {upToTwoDecimal(reports.engine2_Fuel_Flow)}
                                </td>
                              </tr>
                            );
                          }
