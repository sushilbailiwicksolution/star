                        ...
                        <div className="col-md-12">
                            <div className="row">
                                <div className="col-md-8 d-flex align-items-center">
                                    <h2 className="cl-white mr-5">Customers</h2>
                                    <button className="cl-btn cl-btn-tartiary" onClick={() => {props.history.push('/create-customer')}}>Create New Customer</button>
                                </div>
                                                        ...
                                                        <div className="col-md-12">
                                                            ...
                                                            <div className="row mt-4">
                                                                <div className="col-md-12 text-left user-content">
                                                                    ...
                                                                    <p className="m-0">Login Id: <span>sntest</span></p>
                                                                    <p className="m-0">Email :<span>allen.gille@me.com</span></p>
                                                                    <p className="m-0">Mobile: <span>8713933932</span></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
