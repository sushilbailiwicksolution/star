...
/**
 * This component is handling layer creation.
 * @component
 */
function CreateLayer(props: any) {
  ...
  /**
   * Updates the input values with the data received for editing.
   * @param data - The data received for editing.
   */
  ...
  /**
   * Creates a new layer on form submission.
   * @param request - The request data for creating a layer.
   */
  const createLayer = async (request: any) => {
   ...
   /**
   * Updates the layer on form submission.
   * @param request - The request data for updating a layer.
   */
  const updateLayer = async (request: any) => {
   ...
   /**
   * Validates the input fields and returns the validation status.
  ...
  const checkValidation = () => {
    ...
    /**
   * Handles the form submission for creating a new layer.
   * If all fields are valid, sends a request to create a layer.
  ...
  const handleSubmit = (e: any) => {
    ...
    if (check) {
      ...
      requestParams['createdBy'] = logedInUser.results.username;
  ...
  /**
   * Handles the form submission for updating an existing layer.
   * If all fields are valid, sends a request to update the layer.
   * Otherwise, shows validation errors.
   * @param e - The form submission event.
   */
   ...
   * @returns The JSX element for the Create or Update button.
   */
