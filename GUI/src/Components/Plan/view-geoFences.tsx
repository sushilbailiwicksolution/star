                ...
                <div className="col-lg-9 col-xl-10 mt-4">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb p-0">
                            <li className="breadcrumb-item"><a href="#">GeoFences</a></li>
                    ...
                    <table className="table table-striped table-bordered table-dark custom-dark-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Yes</td>
                                    <td className="small-shell"><h3 className="edit-heading">Notify Email</h3></td>
                                    <td>
                                        Yes
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Test_Layer</td>
                                    <td className="small-shell"><h3 className="edit-heading">Buffer Distance</h3></td>
                                    <td>
                                       16.199 nm
                                    </td>
                                </tr>
