...
/**
 * This component is handling landmark lists
 * @component
 */
const LandmarkList = (props: any) => {
  ...
  /**
   * Fetches the list of landmarks from the server.
   */
  ...
  /**
   * Deletes a landmark.
   * @param item - The landmark object to be deleted.
   */
  const deleteLandmark = async (item: any) => {
    ...
    // Fetching logged-in user and account type
