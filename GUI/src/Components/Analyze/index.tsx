    ...
    try {
      if (selectedFlight) {
        ...
        if (airCraftDetails && !airCraftDetails.status) {
          ...
          let departureTime = airCraftDetails.data.departure_time;
          ...
          let arrivalTime = airCraftDetails.data.arrival_time;
          ...
          let obj = {
            ...
            departureTime: airCraftDetails.data.departure_time,
            departure: departureAddress,
            arrival: arrivalAddress,
            duration: duration,
            arrivalTime: airCraftDetails.data.arrival_time,
            data: airCrafts,
...
/**
  ...
  return (
    <React.Fragment>
      ...
      <div className="container-fluid content-body vh-120">
        <div className="row">
          ...
          <div className="col-md-9 my-4 map-box-padding">
            <div className="map-header">
              <ul className="nav align-items-center">
                <li className="nav-item" title="Pan">
            ...
            <div
              ...
              style={{
                ...
                ? selectedTripReplayFlight ? "calc(149vh - 250px)" : "calc(100vh - 250px)"
                :  selectedTripReplayFlight? "calc(149vh - 100px)" : "calc(100vh - 100px)",
            ...
            <div
              ...
              style={{ borderRadius: "0px 0px 10px 10px", height:"50px" }}
            >
              <ul className="nav align-items-center">
