                                ...
                                <ul className="Menulist text-left h-100">
                                    ...
                                    <ul className="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                        <li className="dropdown-submenu">
                                            <a  className="dropdown-item" href="#" >Layers</a>
                                            <ul className="dropdown-menu">
                                                <li className="dropdown-item" onClick={() => { props.history.push('/plan') }}><a href="#">Layers</a></li>
                                                {/* <li className="dropdown-item"><a href="#" onClick={() => {  window.location.href='/location' }}>Location 1</a></li> */}
                                                <li className="dropdown-item"><a href="#" onClick={() => { props.history.push('/landmark') }}>Landmark</a></li>
                                                <li className="dropdown-item"><a  href="#" onClick={() => { props.history.push('/map-layer') }}>KML Layer</a></li>
                                                {/* <li className="dropdown-submenu">
                                        ...
                                        <li className="dropdown-item"><a href="#"  onClick={(e) => {  props.history.push('/notification') }}>Notification</a></li>
                                        <li className="dropdown-item"><a href="#" onClick={(e) => {
