...
function Header(props: any) {
  ...
  <label className="d-block m-0">{logedInUser.results.username} {logedInUser.results.lastname}</label>
  <span style={{ whiteSpace: "nowrap" }}>{logedInUser.results.email_id}</span>
</h4>
...
{ logedInUser.results.accountType !== "USER" && (
                        <button
                          className="dropdown-item"
                          onClick={() => {
                            props.history.push("/graphConfig");
                          }}
                        >
                          Graph Configuration
                        </button>
              ...
              <div className="col-md-3">
                <div className="row h-100">
                  <div className="col-6 d-flex align-items-center">
                    <h4 className="cl-white m-0 text-left header-text-style">
                     {selectedCustomer ? selectedCustomer.name :'' } : <span>customer</span>
                    </h4>
                  </div>
...
{ logedInUser.results.accountType === "SERVICE" && logedInUser.results.customerId===0 &&(<div className="header-icon-bg position-relative">
  <i
  ...
  ></i>
  <div className="notification-count">{customers.length}</div>
  
  {showNotifications ? (
    <div className="notification-message-box" id="notification-message-box">
    {customers.map((customer) => (
      <p
        key={customer.id}
        style={{ cursor: "pointer", fontWeight: customer === selectedCustomer ? "bold" : "normal" }}
