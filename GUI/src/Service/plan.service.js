...
const apiUrl_layer = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_NEST_APIS  + APP_SERVICE + LAYERS;
const apiUrl_landmark = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_NEST_APIS + APP_SERVICE + LANDMARKS;
const apiUrl_users = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_NEST_APIS + APP_SERVICE + USERS;
const apiUrl_notification = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_NEST_APIS + APP_SERVICE + NOTIFICATION;
const apiUrl_assets = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_NEST_APIS + APP_SERVICE + ASSETS;
const apiUrl_geofence = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_NEST_APIS + APP_SERVICE + GEOFENCE;
