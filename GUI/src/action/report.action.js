...
const URL = process.env.REACT_APP_URL + process.env.REACT_APP_URL_OTHER_PORT_REPORT;
...
function getReportFlightOOOI(reportRequest){
  let apiUrl = URL + GET_OOOI_REPORT;
  return (dispatch) => {
    dispatch(request({}));
  ...
  function success(data) {
    return {
      type: ReportConstants.GET_FLIGHT_OOOI_REPORT_SUCCESS,
      value: data,
    };
  }
...
/**
 * This component is used for generating and displaying reports 
 * @component
 */
