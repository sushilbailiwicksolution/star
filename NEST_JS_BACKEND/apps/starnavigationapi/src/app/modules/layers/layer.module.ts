...
@Module({
    imports: [
        TypeOrmModule.forFeature([
            EventBasedNotificationEntity,EventNotificationEntity,EventAssetEntity,
    ...
    providers: [
      NewLayerService,NewUserService, EventNotificationService,
    ...
    controllers: [
       NewLayerController,EventNotificationController,
